...
generated_at: 2026-04-12 04:44:55
---
...
| Sheet 名称 | 内容说明 | 关键字段 |
|-----------|---------|---------|
| 核心 KPI | 核心经营指标汇总 | 总销售额,总订单数,平均客单价,最高单笔销售额 |
| 销售员业绩排名 | 按销售员汇总销售额与订单数进行排名 | 销售员,总销售额,订单数 |
| 城市销售占比 | 各城市销售额占比分析 | 城市,销售额 |
| 客户属性对比 | 新客与其他客户属性（如后续可能出现的老客）的销售对比 | 客户属性,总销售额,订单数 |
| 月度销售趋势 | 按年月粒度统计销售额趋势 | 年月,总销售额 |
| 销售员-产品矩阵 | 销售员与产品交叉维度的销售额汇总 | 销售员,产品,销售额 |
| 销售额异常检测 | 识别销售额显著偏离均值的异常订单 | 总销售额 |
...
#### 第0页：customer_type_comparison
**洞察 Key**: `CHART:customer_type_comparison`
**数据源**: 
**分析维度**: 趋势分析, 对比分析

#### 第0页：city_ranking_horizontal
**洞察 Key**: `CHART:city_ranking_horizontal`
**数据源**: 
**分析维度**: 趋势分析, 对比分析

#### 第0页：salesperson_ranking_horizontal
**洞察 Key**: `CHART:salesperson_ranking_horizontal`
**数据源**: 
**分析维度**: 趋势分析, 对比分析

#### 第0页：monthly_trend_dual
**洞察 Key**: `CHART:monthly_trend_dual`
**数据源**: 
**分析维度**: 趋势分析, 对比分析

#### 第0页：custom_monthly_trend_dual
**洞察 Key**: `CHART:custom_monthly_trend_dual`
**数据源**: 
**分析维度**: 趋势分析, 对比分析

#### 第0页：product_share_pie
**洞察 Key**: `CHART:product_share_pie`
**数据源**: 
**分析维度**: 趋势分析, 对比分析
