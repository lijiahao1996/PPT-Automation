...
generated_at: 2026-04-12 05:46:26
---
...
| 客户属性对比 | 新客与其他客户属性（如后续可能出现的老客）销售对比 | 客户属性,总销售额,订单数 |
| 月度销售趋势 | 按订单时间（月粒度）分析销售额趋势 | 年月,总销售额 |
| 销售员-产品矩阵 | 销售员与产品交叉维度的销售额汇总 | 销售员,产品,销售额 |
| 异常订单检测 | 识别销售额显著偏离均值的异常订单 | 销售额 |
...
#### 第0页：customer_segment_comparison
**洞察 Key**: `CHART:customer_segment_comparison`
**数据源**: 
**分析维度**: 趋势分析, 对比分析
...
#### 第0页：anomaly_orders_overview
**洞察 Key**: `CHART:anomaly_orders_overview`
**数据源**: 
**分析维度**: 趋势分析, 对比分析
