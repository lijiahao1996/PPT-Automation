...
| Sheet 名称 | 内容说明 | 关键字段 |
|-----------|---------|---------|
| 核心用户KPI | 用户基础指标汇总，反映整体规模与活跃度 | 总用户数,总消费次数,平均月薪,平均评分 |
| 城市用户分布 | 各城市用户占比，识别区域覆盖重点 | 城市,用户数 |
| 会员等级排名 | 按会员等级统计用户数与平均消费，评估等级价值 | 会员等级,用户数,平均消费次数 |
| 性别-月薪对比 | 不同性别用户的收入与年龄对比，洞察人群特征 | 性别,平均月薪,平均年龄 |
| 注册时间趋势 | 按月统计新增用户与平均消费次数，监测增长健康度 | 注册日期,当月新增用户,当月平均消费次数 |
| 职业-评分分布 | 各职业用户评分分布，辅助服务质量分析 | 职业,平均评分 |
| 活跃用户分析 | 活跃/非活跃用户占比及对应消费贡献 | 是否活跃,用户数,总消费次数 |
...
#### 第0页：core_kpi_bar_vertical
**洞察 Key**: `CHART:core_kpi_bar_vertical`
**数据源**: 
**分析维度**: 趋势分析, 对比分析

#### 第0页：city_distribution_pie
**洞察 Key**: `CHART:city_distribution_pie`
**数据源**: 
**分析维度**: 趋势分析, 对比分析

#### 第0页：membership_ranking_bar_horizontal
**洞察 Key**: `CHART:membership_ranking_bar_horizontal`
**数据源**: 
**分析维度**: 趋势分析, 对比分析

#### 第0页：gender_salary_age_scatter
**洞察 Key**: `CHART:gender_salary_age_scatter`
**数据源**: 
**分析维度**: 趋势分析, 对比分析

#### 第0页：registration_trend_line
**洞察 Key**: `CHART:registration_trend_line`
**数据源**: 
**分析维度**: 趋势分析, 对比分析

#### 第0页：occupation_rating_bar_vertical
**洞察 Key**: `CHART:occupation_rating_bar_vertical`
**数据源**: 
**分析维度**: 趋势分析, 对比分析

#### 第0页：active_user_funnel
**洞察 Key**: `CHART:active_user_funnel`
**数据源**: 
**分析维度**: 趋势分析, 对比分析
