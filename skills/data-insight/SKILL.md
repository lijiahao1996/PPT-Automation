...
generated_at: 2026-04-12 05:35:35
---
...
| 客户属性对比 | 新客 vs 其他客户属性（需后续扩展，当前仅新客样本，仍保留基础对比结构） | 客户属性,总销售额,订单数 |
| 月度销售趋势 | 按年月粒度统计销售额趋势 | 年月,总销售额 |
| 销售员-产品矩阵 | 销售员与产品交叉维度销售额分析 | 销售员,产品,总销售额 |
...
#### 第0页：city_composition
**洞察 Key**: `CHART:city_composition`
**数据源**: 
**分析维度**: 趋势分析, 对比分析
...
#### 第0页：anomaly_orders_table
**洞察 Key**: `CHART:anomaly_orders_table`
**数据源**: 
**分析维度**: 趋势分析, 对比分析
