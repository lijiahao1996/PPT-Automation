...
generated_at: 2026-04-13 00:13:54
---
...
| Sheet 名称 | 内容说明 | 关键字段 |
|-----------|---------|---------|
| 核心 KPI | 核心经营指标汇总 | 总销售额,总订单数,平均客单价,平均复购率,新增客户总数,平均退货率 |
| 客户分段排名 | 按客户分段统计业绩并排名 | 客户分段,分段销售额,分段订单数,分段新增客户数 |
| 客户分段占比 | 各客户分段对核心指标的贡献占比 | 客户分段,销售额 |
| 月度趋势 | 关键指标月度变化趋势 | 月份,月销售额,月订单数,月平均复购率,月平均退货率 |
| 客户分段 vs 复购率对比 | 不同客户分段的复购率与退货率对比 | 客户分段,平均复购率,平均退货率 |
| 异常检测：销售额波动 | 识别销售额显著偏离均值的月份 | 月销售额 |
...
#### 第0页：core_kpi_horizontal_bar
**洞察 Key**: `CHART:core_kpi_horizontal_bar`
**数据源**: 
**分析维度**: 趋势分析, 对比分析

#### 第0页：customer_segment_ranking_bar
**洞察 Key**: `CHART:customer_segment_ranking_bar`
**数据源**: 
**分析维度**: 趋势分析, 对比分析

#### 第0页：customer_segment_composition_pie
**洞察 Key**: `CHART:customer_segment_composition_pie`
**数据源**: 
**分析维度**: 趋势分析, 对比分析

#### 第0页：monthly_trend_line
**洞察 Key**: `CHART:monthly_trend_line`
**数据源**: 
**分析维度**: 趋势分析, 对比分析

#### 第0页：customer_segment_multi_column
**洞察 Key**: `CHART:customer_segment_multi_column`
**数据源**: 
**分析维度**: 趋势分析, 对比分析

#### 第0页：segment_repurchase_vs_return_scatter
**洞察 Key**: `CHART:segment_repurchase_vs_return_scatter`
**数据源**: 
**分析维度**: 趋势分析, 对比分析
