...
generated_at: 2026-04-12 04:25:00
---
...
| Sheet 名称 | 内容说明 | 关键字段 |
|-----------|---------|---------|
| 核心 KPI | 核心经营指标汇总 | 总销售额,总订单数,平均客单价,最高单额,最低单额 |
| 客户类型对比 | 按维度对比分析 | 客户类型,总销售额,订单数,客单价 |
| 城市排名 | 按维度排名统计 | 城市,总销售额,订单数 |
| 销售员排名 | 按维度排名统计 | 销售员,总销售额,订单数 |
| 自定义月度趋势 | 月度销售趋势分析 | 年月,总销售额,订单数 |
| 月度趋势 | 月度销售趋势分析 | 年月,总销售额,订单数 |
| 产品占比 | 按维度占比分析 | 产品,销售额 |
...
#### 第0页：monthly_trend_sales
**洞察 Key**: `CHART:monthly_trend_sales`
**数据源**: 
**分析维度**: 趋势分析, 对比分析

#### 第0页：monthly_trend_orders
**洞察 Key**: `CHART:monthly_trend_orders`
**数据源**: 
**分析维度**: 趋势分析, 对比分析

#### 第0页：core_kpi
**洞察 Key**: `CHART:core_kpi`
**数据源**: 
**分析维度**: 趋势分析, 对比分析
...
#### 第0页：monthly_trend_custom
**洞察 Key**: `CHART:monthly_trend_custom`
**数据源**: 
**分析维度**: 趋势分析, 对比分析

#### 第0页：monthly_trend_official
**洞察 Key**: `CHART:monthly_trend_official`
**数据源**: 
**分析维度**: 趋势分析, 对比分析
