...
generated_at: 2026-04-08 04:07:39
---
...
#### 第6页：新老客销售贡献对比
**图表 Key**: `CHART:customer_comparison`
**数据源**: 客户类型
**图表类型**: column_clustered
**分析要点**:
- 基于客户类型数据生成洞察
- 分析趋势、对比、占比等业务含义
- 给出具体数据和业务建议
