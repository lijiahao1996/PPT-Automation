...
generated_at: 2026-04-13 02:58:25
---
...
| 客户分段排名 | 按客户分段的销售表现排名 | 客户分段,分段总销售额,分段总订单数,分段新增客户数 |
| 客户分段占比 | 各客户分段对核心指标的贡献占比 | 客户分段,销售额 |
| 月度趋势 | 关键指标月度变化趋势 | 月份,月销售额,月订单数,月平均复购率,月平均退货率 |
| 复购率与新客户对比 | 复购率与新客户数的关联分析 | 客户分段,平均复购率,新客户总数 |
...
#### 第0页：customer_segment_ranking
**洞察 Key**: `CHART:customer_segment_ranking`
**数据源**: 
**分析维度**: 趋势分析, 对比分析

#### 第0页：customer_segment_composition
**洞察 Key**: `CHART:customer_segment_composition`
**数据源**: 
**分析维度**: 趋势分析, 对比分析
...
#### 第0页：repurchase_vs_new_customers
**洞察 Key**: `CHART:repurchase_vs_new_customers`
**数据源**: 
**分析维度**: 趋势分析, 对比分析
