...
generated_at: 2026-04-13 03:32:33
excel_file: 工作表.xlsx
---
...
| 列名 | 数据类型 | 示例值 |
|------|----------|--------|
| `客户分段` | category | A分段, A分段 |
| `月份` | datetime | 2025-01-01 00:00:00, 2025-02-01 00:00:00 |
| `销售额(元)` | numeric | 15600, 16800 |
| `订单数` | numeric | 120, 135 |
| `客单价(元)` | numeric | 130.0, 124.44 |
| `复购率(%)` | numeric | 45, 48 |
| `新客户数` | numeric | 35, 40 |
| `退货率(%)` | numeric | 3.2, 2.8 |
